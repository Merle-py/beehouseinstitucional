...
export default function HomePage() {
    ...
    const [servicesRef, servicesApi] = useEmblaCarousel(
        carouselsReady ? { loop: true, align: 'center', slidesToScroll: 1 } : { watchDrag: false }
    )

    // Embla Carousel for Diferenciais - defer initialization
    const [diferenciaisRef, diferenciaisApi] = useEmblaCarousel(
        carouselsReady ? { loop: true, align: 'center', slidesToScroll: 1 } : { watchDrag: false }
    )
    ...
    useEffect(() => {
        // Initialize carousels and gradients after first paint
    ...
    return (
        <main id="main-content">
            ...
            <footer className="bg-bee-black border-t border-white/10 py-12 md:py-16 relative overflow-hidden">
                {showGradients && <GradientNoise magnitude={0.1} decayRate={0.5} />}
